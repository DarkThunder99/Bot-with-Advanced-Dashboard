...
message.channel.send(`${jsconfig.bot_name} is currently undergoing maintenance which won't allow anyone to access ${jsconfig.bot_name}'s Commands. Feel free to try again later. For updates: https://discord.gg/FqdH4sfKBg`)
